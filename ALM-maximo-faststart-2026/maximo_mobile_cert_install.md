...
1. Before opening the app, visit the following url to prep the mobile app's connection.
    1. API Url
        1. <img width="250" alt="image" src="https://github.com/user-attachments/assets/bad05c67-9ffe-44cc-89c4-a77ffd73508a" />


2. Now you can open up the Maximo Mobile App and scan the following url:
    1. Server URL (Scan from the IBM Maximo Mobile App)
        1. <img width="250" alt="image" src="https://github.com/user-attachments/assets/96834e9f-61b7-4967-bd74-492434d5244a" />
